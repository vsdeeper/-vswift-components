...
import { VsSearch, type VsSearchProps } from '@/components'
import type {
  SCascaderProps,
  SDateProps,
  SInputProps,
      ...
      props: {
        ...
        options: [
          ...
          },
          {
            ...
            children: [
              { id: '2-1', label: '选项2-1' },
              { id: '2-2', label: '选项2-2', children: [{ id: '2-2-1', label: '选项2-2-1' }] }
            ]
          },
          {
            id: '3',
            ...
            children: [
              { id: '3-1', label: '选项3-1' },
              { id: '3-2', label: '选项3-2', children: [{ id: '3-2-1', label: '选项3-2-1' }] }
            ]
          }
        ],
